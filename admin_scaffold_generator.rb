class AdminScaffoldGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    record do |m|
      ...
      # Generate the show and index templates
      ...
      # Generate the _form partial template
      m.template "view_form_partial.html.erb", File.join("app/views", controller_class_path, controller_file_name, "_form.html.erb")
      
      # Generate the edit and new tempaltes
  ...
  protected
    def banner
      "Usage: #{$0} public_scaffold_spec ModelName [field:type field:type]"
    end
